...
CooltrainerFGroup:
	...
	db 17, VOLTORB,    EXPLOSION, SONICBOOM, THUNDER_WAVE, THUNDERBOLT
	db 17, SMEARGLE,    SUBSTITUTE, SPORE, THUNDERPUNCH, ICE_PUNCH
	db -1 ; end
...
PokemaniacGroup:
	...
	db 23, SMEARGLE,    RECOVER, SPORE, SACRED_FIRE, AEROBLAST
	db -1 ; end
