...
; Kanto story events
	...
	const EVENT_TALKED_TO_CINNABAR_GYM_GUY_ONCE
...
; Boarder
	...
	const EVENT_BEAT_BOARDER_NOLAN
	const EVENT_BEAT_BOARDER_LUKE
	const EVENT_BEAT_BOARDER_ELIJAH
	const EVENT_BEAT_BOARDER_JOSIAH
; Sage
...
; Camper
	...
	const EVENT_BEAT_CAMPER_ISAIAH
	const EVENT_BEAT_CAMPER_OLIVER
	const EVENT_BEAT_CAMPER_LOGAN
	const EVENT_BEAT_CAMPER_JOSEPH
; Burglar
...
; Picnicker
	...
	const EVENT_BEAT_PICNICKER_LUNA
	const EVENT_BEAT_PICNICKER_ABIGAIL
	const EVENT_BEAT_PICNICKER_ADDISON
	const EVENT_BEAT_PICNICKER_IVY
; Guitarist
...
; Beauty
	...
	const EVENT_BEAT_BEAUTY_AMBER
	const EVENT_BEAT_BEAUTY_AURORA
	const EVENT_BEAT_BEAUTY_WILLOW
	const EVENT_BEAT_BEAUTY_MAYA
...
; Lass
	...
	const EVENT_BEAT_LASS_EMILY
	const EVENT_BEAT_LASS_ZOEY
	const EVENT_BEAT_LASS_DAKOTA
	const EVENT_BEAT_LASS_CARLIE
; Hiker
...
; Bug Catcher
	...
	const EVENT_BEAT_BUG_CATCHER_RANDY
	const EVENT_BEAT_BUG_CATCHER_VINCE
	const EVENT_BEAT_BUG_CATCHER_NOAH
	const EVENT_BEAT_BUG_CATCHER_WALLY
	const EVENT_BEAT_BUG_CATCHER_GUS
	const EVENT_BEAT_BUG_CATCHER_MILES
...
; Skier
	...
	const EVENT_BEAT_SKIER_RIDLEY
	const EVENT_BEAT_SKIER_OLIVIA
	const EVENT_BEAT_SKIER_AVA
	const EVENT_BEAT_SKIER_SADIE
; SwimmerM
...
; Youngster
	...
	const EVENT_BEAT_YOUNGSTER_XANDER
	const EVENT_BEAT_YOUNGSTER_GABE
	const EVENT_BEAT_YOUNGSTER_REID
	const EVENT_BEAT_YOUNGSTER_LIAM
	const EVENT_BEAT_YOUNGSTER_LUCAS
	const EVENT_BEAT_YOUNGSTER_MATEO
	const EVENT_BEAT_YOUNGSTER_MASON
	const EVENT_BEAT_YOUNGSTER_LEVI
	const EVENT_BEAT_YOUNGSTER_DORAN
; Teacher
...
; Unused: next 131 events
	...
	const EVENT_ROUTE_46_YOUNGSTER_BLOCKS_PATH
	const EVENT_ECRUTEAK_CITY_LASS_BLOCKS_EAST
...
; Kanto people
	...
	const EVENT_CINNABAR_GYM_GYM_GUY
...
; Unused: next 116 events
	...
	const EVENT_CERULEAN_CAVE_1F_HIDDEN_HYPER_POTION
	const EVENT_CERULEAN_CAVE_1F_HIDDEN_REVIVE
	const EVENT_CERULEAN_CAVE_1F_HIDDEN_RARE_CANDY
	const EVENT_CERULEAN_CAVE_2F_THUNDERSTONE
	const EVENT_CERULEAN_CAVE_2F_PP_UP
	const EVENT_CERULEAN_CAVE_2F_ULTRA_BALL
	const EVENT_CERULEAN_CAVE_2F_SCOPE_LENS
	const EVENT_CERULEAN_CAVE_2F_HIDDEN_PP_UP
	const EVENT_CERULEAN_CAVE_2F_HIDDEN_CALCIUM
	const EVENT_CERULEAN_CAVE_2F_HIDDEN_FULL_HEAL
	const EVENT_CERULEAN_CAVE_2F_HIDDEN_BIG_PEARL
	const EVENT_CERULEAN_CAVE_B1F_HIDDEN_NUGGET
	...
	const EVENT_VIRIDIAN_CITY_LASS_BLOCKS_TRAINER_HOUSE
	const EVENT_VERMILION_CITY_YOUNGSTER1_BLOCKS_ROUTE
	const EVENT_VERMILION_CITY_YOUNGSTER2_BLOCKS_ROUTE
	const EVENT_SAFFRON_CITY_LASS3_BLOCKS_GATE
	const EVENT_SAFFRON_CITY_LASS4_BLOCKS_GATE
	const EVENT_SAFFRON_CITY_YOUNGSTER3_BLOCKS_GATE
	const EVENT_SAFFRON_CITY_YOUNGSTER4_BLOCKS_GATE
	const EVENT_SAFFRON_CITY_YOUNGSTER5_BLOCKS_GATE
	const EVENT_CELADON_CITY_GRAMPS_BLOCKS_GYM
	const EVENT_VIRIDIAN_CITY_YOUNGSTER_BLOCKS_GYM
	const EVENT_PEWTER_CITY_YOUNGSTER_BLOCKS_GYM
	const EVENT_SAFARI_ZONE_WEST_ZAPDOS
	const EVENT_GOT_SAFARI_ZONE_MASTERBALLS
	const EVENT_SAFARI_ZONE_HUB_FULL_RESTORE
	const EVENT_SAFARI_ZONE_HUB_MAX_REVIVE
	const EVENT_SAFARI_ZONE_NORTH_CARBOS
	const EVENT_SAFARI_ZONE_NORTH_HYPER_POTION
	const EVENT_SAFARI_ZONE_NORTH_RARE_CANDY
	const EVENT_SAFARI_ZONE_EAST_PROTEIN
	const EVENT_SAFARI_ZONE_EAST_NUGGET
	const EVENT_SAFARI_ZONE_EAST_ELIXER
	const EVENT_SAFARI_ZONE_EAST_ULTRA_BALL
	const EVENT_SAFARI_ZONE_WEST_IRON
	const EVENT_SAFARI_ZONE_WEST_MAX_POTION
	const EVENT_SAFARI_ZONE_WEST_ETHER
	const EVENT_SAFARI_ZONE_WEST_MAX_REPEL
	const EVENT_VIRIDIAN_FOREST_CALCIUM
	const EVENT_VIRIDIAN_FOREST_PP_UP
	const EVENT_VIRIDIAN_FOREST_FULL_RESTORE
	const EVENT_VIRIDIAN_FOREST_MAX_REPEL
	const EVENT_MOUNT_MOON_MEW
	const EVENT_ROCK_TUNNEL_MOLTRES
	const EVENT_FUCHSIA_CITY_GRAMPS_BLOCKS_SAFARI_ZONE
	const EVENT_CERULEAN_CITY_LASS_BLOCKS_CERULEAN_CAVE
