...
FuchsiaGym_MapEvents:
	...
	db 6 ; object events
	object_event  4, 11, SPRITE_JANINE, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, FuchsiaGymJanineScript, -1
	object_event  4,  8, SPRITE_FUCHSIA_GYM_1, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 3, LassAliceScript, -1
	object_event  2,  2, SPRITE_FUCHSIA_GYM_2, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 2, LassLindaScript, -1
	object_event  6,  4, SPRITE_FUCHSIA_GYM_3, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 2, PicnickerCindyScript, -1
	object_event  7,  2, SPRITE_FUCHSIA_GYM_4, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 2, CamperBarryScript, -1
