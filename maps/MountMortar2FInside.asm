...
MountMortar2FInside_MapEvents:
	...
	db 1 ; bg events
	bg_event 18,  6, BGEVENT_ITEM, MountMortar2FInsideHiddenFullRestore
	...
	object_event  3, 11, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, MountMortar2FInsideElixer, EVENT_MOUNT_MORTAR_2F_INSIDE_ELIXER
